...
class UNet2D(nn.Module):
    def __init__(self, in_channels=4, out_channels=2):
        ...
        #decoder de mujer
        self.upconv1 = nn.ConvTranspose2d(1280, 96, kernel_size=4, stride=2, padding=1) # 96 8 8
        self.ir1 = InvertedResidual(96 + 96, 96, expand_ratio=6, stride=1) # 96 8 8

        self.upconv2 = nn.ConvTranspose2d(96, 32, kernel_size=4, stride=2, padding=1) # 32 16 16
        self.ir2 = InvertedResidual(32 + 32, 32, expand_ratio=6, stride=1) # 32 16 16

        self.upconv3 = nn.ConvTranspose2d(32, 24, kernel_size=4, stride=2, padding=1) # 24 32 32
        self.ir3 = InvertedResidual(24 + 24, 24, expand_ratio=6, stride=1) # 24 32 32

        self.upconv4 = nn.ConvTranspose2d(24, 16, kernel_size=4, stride=2, padding=1) # 16 64 64
        self.ir4 = InvertedResidual(16 + 16, 16, expand_ratio=6, stride=1) # 16 64 64

        self.upconv5 = nn.ConvTranspose2d(16, out_channels, kernel_size=4, stride=2, padding=1) # 2 128 128
