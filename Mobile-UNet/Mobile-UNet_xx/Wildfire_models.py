...
class UNet2D(nn.Module):
    def __init__(self, in_channels=4, out_channels=2):
        ...
        #decoder de mujer
        self.upconv1 = QATConvTranspose2d(1280, 96, kernel_size=4, stride=2, padding=1)
    ...
    def forward(self, x):
        ...
        l1 = self._match_and_cat(self.upconv1_quant(self.upconv1(x5)), x4) # 192 8 8
        l2 = self.ir1(l1) # 96 8 8
        l3 = self._match_and_cat(self.upconv2_quant(self.upconv2(l2)), x3) # 64 16 16
        l4 = self.ir2(l3) # 32 16 16
        l5 = self._match_and_cat(self.upconv3_quant(self.upconv3(l4)), x2) # 48 32 32
        l6 = self.ir3(l5) # 24 32 32
        l7 = self._match_and_cat(self.upconv4_quant(self.upconv4(l6)), x1) # 32 64 64
        l8 = self.ir4(l7) # 16 64 64

        out = self.upconv5(l8) # N 128 128
